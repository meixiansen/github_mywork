...
public:
    ...
    void refinement(const Rect rec,Mat roi_mask, pcl::PointCloud<pcl::PointXYZRGB>::Ptr _cloud,vector<int> labels,Mat roi,int *truelabels1,vector<SPixels> &t_superpixels);
    void runSegemnt();
