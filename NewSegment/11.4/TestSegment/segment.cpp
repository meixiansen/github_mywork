...
Segment::Segment(Mat img,pcl::PointCloud<pcl::PointXYZRGB>::Ptr _cloud,Mat bgmodel)
{
...
//        imwrite("superpixel_region.png",superpixel_region);
//        imwrite("mask_substract.png",mask_substract);
...
//    }
//     cout<<"over"<<endl;
//    imshow("isolate_mask1",isolate_mask);
    for(int l=0;l<labels.size();l++)
    {
...
//        imshow("isolate_mask2",isolate_mask);
//        waitKey(0);
...
//            cout<<reca.x<<" "<<reca.y<<" "<<reca.width<<" "<<reca.height<<endl;
//            imshow("roi",roi);
//            waitKey(0);
