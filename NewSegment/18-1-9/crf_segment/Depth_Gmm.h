...
public:
    ...
    void init(Size _frameSize, int _frameType);
    ...
    void run(Mat _image, OutputArray _fgmask, double learningRate);

    void run(Mat _image, OutputArray _fgmask, double learningRate,Mat _bgmodel);
protected:
    Size frameSize;
    int frameType;
    cv::Mat bgmodel;
