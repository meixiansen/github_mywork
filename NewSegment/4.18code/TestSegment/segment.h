...
//获取自定义核
const int g_nStructElementSize1 = 1;
...
const int g_nStructElementSize2 = 2;
...
public:
    ...
    void refinement(const cv::Point _vertex, pcl::PointCloud<pcl::PointXYZRGB>::Ptr _cloud,vector<int> labels,Mat roi,int *truelabels1,vector<SPixels> &t_superpixels);
    void runSegemnt();
