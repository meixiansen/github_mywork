...
public:
   ...
   queue<vector<Point>> q_contours;
    ...
    vector<Object> processSingle(vector<int> labels,Mat roi_mask,Rect rec,Mat roi,Mat label_mask,int *truelabels1,vector<SPixels> &t_superpixels);
    ...
    static void* thread_process(void *_this);
